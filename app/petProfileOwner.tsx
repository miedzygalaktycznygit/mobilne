  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.idCard}>
        ...
        <Text style={styles.idDesc}>Podaj ten kod weterynarzowi lub hotelowi.</Text>
      </View>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Historia Medyczna (Tylko do odczytu)</Text>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.entry}>
          ...
          <Text style={styles.entryDoctor}>Notatka: Bardzo grzeczny, dobrze jadł.</Text>
        </View>
      </View>
    </ScrollView>
  );
